...
system("/public/home/yuejingjing/tyh/protocol/rpanno-stat/splitChrByFa.pl $opt_i");
while(my $file = glob "fabyChr/*.fasta"){
	my $trf_cmd = "/public/home/yuejingjing/mambaforge/envs/EDTA/bin/trf $file 1 1 2 80 5 200 2000 -d -h";
	system($trf_cmd);
	}
